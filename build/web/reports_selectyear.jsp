...
//               
 ...
 <br/>
    ...
    %>
            ...
            <br/>
            <h3 style="background-color: greenyellow;text-align: center;"> ANC VISITS SUMMARY PER  SITE, VILLAGE AND YEAR </h3>
            
            <div id="content" style="width:1020px;">
       
                 
                    <form action="ancvisitpervillage" method="post" style="margin-left: 400px;margin-top: 20px;width:400px;">
