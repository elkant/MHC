...
<title>Maternity Register Reports</title>
...
//               
 ...
 <br/>
    ...
    %>
            ...
            <br/>
            <h3 style="background-color: greenyellow;text-align: center;"> MATERNITY BABY AND MOTHER STATUS SUMMARY PER  SITE , VILLAGE AND YEAR </h3>
            
            <div id="content" style="width:1020px;">
       
                 
                    <form action="maternityreports" method="post" style="margin-left: 400px;margin-top: 20px;width:400px;">
                       <table cellpadding="5px" style="margin-left: 100px;">
                           <tr><td> Select Year </td></tr>
                           <tr><td>
                        <select id="year" name="year" class="textbox6" style="height:80px;" required multiple >
