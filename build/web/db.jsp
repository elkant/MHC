    ...
    <body>
        <div id="container" style="height:620px;">
            ...
            <div id="content" style="height:500px;margin-left:50px; overflow:hidden ;">
                ...
                <form action="updatedbpword" method="post" style="margin-left: 100px; height:340px; width:540px;">
                    ...
                    <table style="margin-left:120px;width:300px;"   cellpadding="8px" cellspacing="6px">
                        ...
                        <tr> <td style="text-align: right;">Database : <img src="images/blguide.png" title="enter the database name e.g mhc"/></td>
                            <td style="text-align: right;"><input id="database"  type=text required name=database value="mhc" placeholder="e.g mnhc"  class="textbox"/></td>
                        </tr>
