 ...
 * @author SIXTYFOURBIT
 */
public class editancnum extends HttpServlet {
...
//  String unique=(String)session.getAttribute("countyid");
        ...
        // update the mname
         ...
         else if (columnName.equals("ANC No")) {
            try {
                query1 = "update mother_details set timestamp='"+mdate+"', anc_no='" + value + "' where motherID='" + id + "'";



                conn.st.executeUpdate(query1);
                conn.st.executeUpdate("update atoh set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
                conn.st.executeUpdate("update itop set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
                conn.st.executeUpdate("update qtow set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
                conn.st.executeUpdate("update xtoad set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
                conn.st.executeUpdate("update aetoak set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
                conn.st.executeUpdate("update altoan set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
                conn.st.executeUpdate("update maternal_details set timestamp='"+mdate+"', ancno='" + value + "' where motherid='" + id + "'");
