 ...
 * @author SIXTYFOURBIT
 */
public class searchchwfulani extends HttpServlet {
    ...
    name=request.getParameter("chwname");
    qualifying_chw="";
    qualifying_chw="<tr>"
            + "<th>NO</th>"
            + "<th>First Name</th>"
   ...
   +"</form></td>"
    ...
    try {
        ...
        out.close();
            ...
            Logger.getLogger(searchchwfulani.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
