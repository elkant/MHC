 ...
 * @author Maureen
 */
public class UpdateMothersDiary extends HttpServlet {
  ...
  // String query = "SELECT * FROM anc_visits WHERE DATE(VisitDate) = DATE(NOW())";  
            // check to see if the arraylist is empty or not then clears the arraylist after each loo[ to avoid duplication or same data been displayed after a refresh 
...
//                         query="SELECT * FROM anc_visits WHERE DATE(VisitDate) = DATE(CURDATE()-2)";
                          ...
                          System.out.println("ID======="+DB.getVISITID());
                           ...
                           query1= "SELECT * FROM mother_details where anc_no='"+anc+"'";
                            conn.rs2 = conn.state2.executeQuery(query1);
                                 ...
                                 String nextJSP = "/UpdateDiary.jsp";
   ...
   response.sendRedirect("UpdateDiary.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateMothersDiary.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
