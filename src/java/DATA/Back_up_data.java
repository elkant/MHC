 ...
 */
public class Back_up_data extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            found_folder = "";
                  ...
                  String getversion=" select version_name from version";
                  String versionno="";
                  ...
                  versionno=conn.rs.getString(1).trim().replace("/","_").substring(begpos);
