 ...
 * @author Manuel
 */
public class chwbased_worksheets extends HttpServlet {
   ...
   String additiaonalparrams="EXTRACT(YEAR FROM VisitDate) ='"+Year+"' ";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            wb = new HSSFWorkbook();
             String columnheaders[]={"SURVEY DATE","ANC NUMBER","FIRST NAME","MIDDLE NAME","LAST NAME","PHONE NO.","NOK PHONE NO.","EXPECTED DELIVERY DATE","LAST VISIT DATE","CURRENT FACILITY","PREFFERED FACILITY","FACILITY VISITING","CHW'S NAME","CHWS PHONE NO."};
             ...
             String registerdetailsheaders3[]={"SURVEY DATE","ANC NUMBER","FIRST NAME","MIDDLE NAME","LAST NAME","EDD","FACILITY","VILLAGE","1st VISIT","2nd VISIT","3rd VISIT","4th VISIT","5th AND ABOVE","LIVE BIRTH","FRESH STILL BIRTH","MACERATED STILL BIRTH","ALIVE","DEAD","COMPLICATION TYPE"};
...
//=================DEFINE THE COLUMN  HEADERS PER EACH FACILITY SHEET========================
            ...
            missingmothers.addMergedRegion(new CellRangeAddress(0, 0, sheetsstartcel, maxmerging-1));
                ...
                String mainqr = "Select  anc_no, DOB ,FName ,SName,LName,PhoneNo ,NOKPhoneNo,ANCVisits_now,VisitDate,mother_details.delivery_date as delivery_date,status_id,Age,nok_consent,languagePreferred,facilityname, ChwID,prefered_Health, Survey_Date from mother_details "
                        + " left join mother_profile  on (mother_details.anc_no=mother_profile.ANC_Num and mother_details.facilityname=mother_profile.health_facility) where Survey_Date <='2014-08-19'  order by FName desc ";
 ...
 //SURVEY_DATE
  ...
  HSSFCell regdetailscellxx1 = regdetailsworksheetrws.createCell(cellpos1);
                    regdetailscellxx1.setCellValue(conn.rs.getString("Survey_date"));
                    regdetailscellxx1.setCellStyle(data_style);

                    if (conn.rs.getString("Survey_date") == null || conn.rs.getString("Survey_date").equals("")) {
                        regdetailscellxx1.setCellValue("NO SURVEY_DATE");
                    } 
...
//===========================================BABY STATUS============================
  ...
  HSSFCell regdetailscellxx1 = allsitesworksheetrws.createCell(cellpos);
                    regdetailscellxx1.setCellValue(conn.rs.getString("Survey_date"));
                    regdetailscellxx1.setCellStyle(data_style);
...
//=====================SET CELL WIDTH FOR THE MAIN WIDTH AND==================================
            ...
            Logger.getLogger(chwbased_worksheets.class.getName()).log(Level.SEVERE, null, ex);
        }
