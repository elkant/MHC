 ...
 * @author Manuel
 */
public class monthlymobilelinks extends HttpServlet {
   ...
   String additiaonalparrams="EXTRACT(YEAR FROM VisitDate) ='"+Year+"' ";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String startdate="201308";
            String enddate="201410";
    ...
    wb1=null;
           ...
           maincountqry="select count(*) as curcount from mother_details where "+additiaonalparrams+"  facilityname LIKE ";
            ...
            HSSFSheet registerdetails = wb1.createSheet("MOTHERS REGISTER DETAILS");
            ...
            HSSFFont font_header = wb1.createFont();
            ...
            //font data
            HSSFFont datafont = wb1.createFont();
            ...
            CellStyle style_header = wb1.createCellStyle();
            ...
            CellStyle th_style = wb1.createCellStyle();
            ...
            CellStyle data_style = wb1.createCellStyle();
            ...
            CellStyle lostyle = wb1.createCellStyle();
            ...
            CellStyle innerdata_style = wb1.createCellStyle();
...
+" (atoh left join  mat_vtoab on atoh.motherid=mat_vtoab.motherid"
     +"  left join  mat_mtou on atoh.motherid=mat_mtou.motherid  )" 
+" on mother_details.motherID=atoh.motherid "
+" where (mother_details.facilityname LIKE 'solian' or mother_details.facilityname like 'Emining' or mother_details.facilityname like 'Ngubereti') and EXTRACT(YEAR_MONTH FROM DateofVisit) >= '"+startdate+"' and EXTRACT(YEAR_MONTH FROM DateofVisit) <= '"+enddate+"'"
        + "group by MOTHERID order by YEARMONTH, FACILITY,VISITNUMBER,BABYSTATUS,COMPLICATIONS ASC";
...
//while(conn.rs_5.next()){
    ...
    int monthcopypos1=2;     
                ...
                while (conn1.rs_5.next()) {
                            ...
                            //if the current mother is in the martins list
  String checkexistance1="select * from mother_details  where anc_no like '"+conn1.rs_5.getString("ANCNO")+"' and facilityname LIKE '"+conn1.rs_5.getString("FACILITY")+"' ";
               
                    
               conn.rs=conn.st.executeQuery(checkexistance1);     
                if(conn.rs.next()){    
                    System.out.println(conn.rs.getString("anc_no")+" _______"+checkexistance1); 
                    //now check whether the selected mother exists in the anc
   ...
   facilitycopy=conn1.rs_5.getString("FACILITY");
                ...
                if(visit1mom>0){
                    ...
                    allsitescellvis1.setCellStyle(data_style);
                     System.out.println("Row no:  "+regsitesrowno+"====Visit1==="+visit1mom+" and sum is "+sumvisit1mom );                     
                    }
                else {
                ...
                if(visit2mom>0){
                    ...
                    allsitescellvis1.setCellStyle(data_style);
                      System.out.println("Row no:  "+regsitesrowno+"====Visit2==="+visit2mom+" and sum is "+sumvisit2mom );                     
                ...
                if(visit3mom>0){
                    ...
                    allsitescellvis1.setCellStyle(data_style);
                      System.out.println("Row no:  "+regsitesrowno+"====Visit3==="+visit3mom+" and sum is "+sumvisit3mom );                     
                ...
                if(visit4mom>0){
                    ...
                    System.out.println("Row no:  "+regsitesrowno+"====Visit4==="+visit4mom+" and sum is "+sumvisit4mom );                     
...
//===========================================BABY STATUS============================
 ...
 //===========================================================================================================
                    ...
                    if(conn1.rs_5.getString("VISITNUMBER").equals("1st Visit")){
                     ...
                     visit1mom++;                       
                       //  System.out.println(conn1.rs_5.getString("YEARMONTH")+" Visit 1 "+visit1mom+" Facil is "+conn1.rs_5.getString("FACILITY"));                 
                    }
                    ...
                    visit2mom++;
                    //sumvisit2mom++;
                   //  System.out.println(conn1.rs_5.getString("YEARMONTH")+" Visit2 "+visit2mom+" Facil is "+conn1.rs_5.getString("FACILITY"));                 
                    ...
                    visit3mom++;
                    //sumvisit3mom++;
                   //  System.out.println(conn1.rs_5.getString("YEARMONTH")+" Visit3 "+visit3mom+" Facil is "+conn1.rs_5.getString("FACILITY"));                 
...
//begin writing to the register at this point.
  ...
  //merge months
   ...
   //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
                ...
                }//end of my code to check whether the selected mother belongs to the ANC  
   ...
   //      Create the last row
            ...
            int cellpos1=0;    
                ...
                if(visit2mom>0){
                    ...
                    allsitescellvis1.setCellStyle(data_style);
                    sumvisit2mom+=visit2mom;  
                     System.out.println("==========="+visit2mom+" and sum is "+sumvisit2mom ); 
                    }
                else {
...
//=====================SET CELL WIDTH FOR THE MAIN WIDTH AND==================================
        ...
        response.setHeader("Content-Disposition", "attachment; filename=MONTHLY_MOBILE_ANC_VISITS_AND_MATERNITY_" + dat1 + ".xls");
