 ...
 * @author Manuel
 */
public class MobileVisitingFacility extends HttpServlet {
   ...
   String additiaonalparrams="EXTRACT(YEAR FROM VisitDate) ='"+Year+"' ";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            wb = new HSSFWorkbook();
             String columnheaders[]={"ANC NUMBER","FIRST NAME","MIDDLE NAME","LAST NAME","PHONE NO.","NOK PHONE NO.","EXPECTED DELIVERY DATE","LAST VISIT DATE","CURRENT FACILITY","PREFFERED FACILITY","CHW'S NAME","CHWS PHONE NO."};
             ...
             String registerdetailsheaders3[]={"ANC NUMBER","FIRST NAME","MIDDLE NAME","LAST NAME","EDD","CURRENT FACILITY","VILLAGE","1st VISIT","2nd VISIT","3rd VISIT","4th VISIT","5th AND ABOVE","LIVE BIRTH","FRESH STILL BIRTH","MACERATED STILL BIRTH","ALIVE","DEAD","COMPLICATION TYPE"};
...
//=================DEFINE THE COLUMN  HEADERS PER EACH FACILITY SHEET========================
            ...
            registerdetails.addMergedRegion(new CellRangeAddress(1, 2, complicationcell+1,registerdetailsheaders2.length-1));
                ...
                String mainqr = "Select anc_no, DOB ,FName ,SName,LName,PhoneNo ,NOKPhoneNo,LocationID,Gest_to_firstANC,Anc_visit,VisitDate,delivery_date,status_id,Age,Gravida,parity,maritalStatus,education,occupation,nok_consent,languagePreferred,facilityname, ChwID from mother_details   order by FName desc";
...
//=====================SET CELL WIDTH FOR THE MAIN WIDTH AND==================================
            ...
            Logger.getLogger(MobileVisitingFacility.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        response.setHeader("Content-Disposition", "attachment; filename=FACILITY_VISITED_" + dat1 + ".xls");
