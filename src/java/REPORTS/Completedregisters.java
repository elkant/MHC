 ...
 * @author Manuel
 */
public class Completedregisters extends HttpServlet {

    HSSFWorkbook wb;
    int maxmerging=0;
    String maincountqry="";
    String completereccountqry="";
   ...
   String Statisticsarr[] = {"FACILITY", "ANC MOTHERS", "MATERNITY MOTHERS", "PNC MOTHERS", "COMPLETE RECORDS"};
   dbConn conn =null;
...
//[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]][[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
         ...
         laststatisticsrow.setHeightInPoints(30);
            ...
            //=====TOTAL COMPLETE MUMS
            totalcol.setCellValue(TOTALCOMPLETEMOMS);
...
//=====================SET CELL WIDTH FOR THE MAIN WIDTH AND==================================
        ...
        response.setHeader("Content-Disposition", "attachment; filename=KOIBATEK_DATA_" + dat1 + ".xls");
    ...
    public int createsummaryreport(String yr){
        try {
           ...
           HSSFRow  rw2 = statistics.createRow(count+1);
            ...
            statistics.addMergedRegion(new CellRangeAddress(count, count, 4, 8));
            ...
            //==FACILITY NAME  || ANC MOTHERS ||MATERNITY MOTHERS|| PNC MOTHERS   ||  TOTAL
               ...
               for (int a = 0; a < Statisticsarr.length; a++) {
                ...
                rwycell1.setCellStyle(th_style);
                    ...
                    additiaonalparrams="( EXTRACT(YEAR FROM postnat_atof.VisitDate) ='"+yr+"' and EXTRACT(YEAR FROM mat_atoh.AdmissionDate) ='"+yr+"' and  EXTRACT(YEAR FROM atoh.DateofVisit) ='"+yr+"' ) and";
              ...
              completereccountqry=" select count(distinct mother_details.motherID) as curcount from mother_details join atoh on mother_details.motherID=atoh.motherid join postnat_atof on mother_details.motherID=postnat_atof.motherid join mat_atoh on mother_details.motherID=mat_atoh.motherid where (AdmissionNo!='null' ) and (atoh.ancno!='null' ) and postnat_atof.PNCRegNo!='null' and  "+additiaonalparrams+"  facilityname LIKE ";
                   ...
                   pncmaincountqry="  select count(distinct postnat_atof.motherid) as curcount from mother_details join atoh on mother_details.motherID=atoh.motherid join mat_atoh on mother_details.motherID=mat_atoh.motherid join postnat_atof on mother_details.motherID=postnat_atof.motherid where "+pncadditiaonalparrams+"  facilityname LIKE ";
                   matmaincountqry=" select count(distinct mat_atoh.motherid) as curcount from mother_details join mat_atoh on mother_details.motherID=mat_atoh.motherid join atoh on mother_details.motherID=atoh.motherid where "+matadditiaonalparrams+"  facilityname LIKE ";
                ...
                while(conn.rs1.next()){    
                    ...
                    String Facilityname=conn.rs1.getString(1);
                       ...
                       HSSFRow rwy1 = statistics.createRow(count + 1);
                        ...
                        //======COMPLETE MUMS
                        HSSFCell completecol = rwy1.createCell(8);
        ...
        //
                        ...
                        String totalqr = completereccountqry+" '" + conn.rs1.getString("facilityname") + "' ";
                        ...
                        if (conn.rs3.next()) {
                            COMPLETEMOMS = conn.rs3.getInt("curcount");
                        }
                        completecol.setCellValue(PNCMOMS);

                        completecol.setCellStyle(innerdata_style);

                        TOTALCOMPLETEMOMS += PNCMOMS;
                        System.out.println("^^^^^^^^^^^^^^^^^^^" + COMPLETEMOMS + " TOTAL MOTHERS IN FACILITY  " + Facilityname);
         ...
         lastatatisticsrow.setHeightInPoints(30);
            ...
            //=======COMPLETE COLS=====================
            HSSFCell completecol = lastatatisticsrow.createCell(8);
            ...
            //=====TOTAL TOTALS
            completecol.setCellValue(YEARLYTOTALPNCMOMS);
