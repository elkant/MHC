...
//               
 ...
 <br/>
    ...
    %>
            ...
            <br/>
            <h3 style="background-color: greenyellow;text-align: center;"> ANC,MATERNITY,PNC DATA SUMMARIES </h3>
            
            <div id="content" style="width:1020px;">
       
                 
                    <form action="allregistersummaries" method="post" style="margin-left: 400px;margin-top: 20px;width:400px;">
