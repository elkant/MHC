...
<title>COMPLETE REGISTERS</title>
...
//               
 ...
 <br/>
    ...
    %>
            ...
            <br/>
            <h3 style="background-color: greenyellow;text-align: center;"> KOIBATEK DATA SUMMARIES INCLUDING </h3>
            
            <div id="content" style="width:1020px;">
       
                 
                    <form action="Completedregisters" method="post" style="margin-left: 400px;margin-top: 20px;width:400px;">
