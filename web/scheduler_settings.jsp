...
<script type="text/javascript">       
         ...
         var SCHEDULERNAME="CENTRALSCHEDULER";    
...
//and once logged out, session invalidated, send to login page
    ...
    <body>
        <div id="container" style="height:620px;">
            ...
            <div id="header" style="width:1100px; margin-left: 25px;">
                <!--=========================================menu=========================================-->     
                <br/>
            ...
            <div id="content" style="margin-left:150px">
                ...
                <%
                    ...
                    conn.rs = conn.st.executeQuery(allschedules);
     ...
     <p align="center"> Enter  appropriate settings for each sms </p>
